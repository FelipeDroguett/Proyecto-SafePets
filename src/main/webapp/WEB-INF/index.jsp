...
<body class="is-preload">
    ...
    <div id="wrapper" class="fade-in">
        ...
        <div id="intro">
            <h1>This is<br />
                Safe Pet</h1>
            <p>If you want to know more about our page visit <a href="#"># </a> <br />
                Or if you want, contact support <a href="https://html5up.net/license">#</a>.</p>
            <ul class="actions">
        ...
        <!-- Header -->
        <header id="header">
            <a href="index.html" class="logo">Safe Pet</a>
        </header>

        <!-- Nav -->
        <nav id="nav">
            <ul class="links">
                <li class="active"><a href="index.html">This is Safe Pet </a></li>
        ...
        <div id="main">
            ...
            <article class="post featured">
                <header class="major">
                    <span class="date">API fecha actual</span>
                    <h2><a href="#">Tittle<br />
                            Subtittle</a></h2>
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="3000">
                                <img src="assets/img/anciano-gato-mascota.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item" data-bs-interval="3000">
                                <img src="assets/img/hombre-entrenando-sus-perros-pitbull.jpg" class="d-block w-100"
                                    alt="...">
                            </div>
                            <div class="carousel-item" data-bs-interval="3000">
                ...
                <ul class="actions special">
                    <li><a href="#" class="button large">Mision</a></li>
                </ul>
            </article>
            ...
            <section class="posts">
                <article>
                    <header>
                        <span class="date">API fecha actual o fecha de publicacion</span>
                        <h2><a href="#">Tittle<br />
                                Subtittle</a></h2>
                    </header>
                    <a href="#" class="image fit"><img src="assets/img/fundacion1.jpg" alt="" /></a>
                ...
                <article>
                    ...
                    <a href="#" class="image fit"><img src="assets/img/fundacion2.jpg" alt="" /></a>
                    <p>Donec eget ex magna. Interdum et malesuada fames ac ante ipsum primis in faucibus. Pellentesque
                        venenatis dolor imperdiet dolor mattis sagittis magna etiam.</p>
                    <ul class="actions special">
                        <li><a href="#" class="button">About</a></li>
                ...
                <article>
                    ...
                    <a href="#" class="image fit"><img src="assets/img/fundacion3.jpg" alt="" /></a>
                    <p>Donec eget ex magna. Interdum et malesuada fames ac ante ipsum primis in faucibus. Pellentesque
                        venenatis dolor imperdiet dolor mattis sagittis magna etiam.</p>
                    <ul class="actions special">
                        <li><a href="#" class="button">About</a></li>
                ...
                <article>
                    ...
                    <a href="#" class="image fit"><img src="assets/img/fundacion4.1.jpg" alt="" /></a>
                    <p>Donec eget ex magna. Interdum et malesuada fames ac ante ipsum primis in faucibus. Pellentesque
                        venenatis dolor imperdiet dolor mattis sagittis magna etiam.</p>
                    <ul class="actions special">
                        <li><a href="#" class="button">About</a></li>
